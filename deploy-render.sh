...
echo "   - SOURCE_NUMBER=your_bot_whatsapp_number"
echo "   - TARGET_NUMBER=your_user_whatsapp_number"
echo "   - ALLOWED_NUMBERS=your_user_whatsapp_number"
echo "   - NPM_TOKEN=your_npm_token (REQUIRED for build)"
...
echo "🔑 For NPM token setup, see: NPM_TOKEN_SETUP.md"
echo ""
echo "⚠️  Important Notes:"
echo "- NPM_TOKEN is REQUIRED for successful build"
